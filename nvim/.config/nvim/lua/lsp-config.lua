...
vim.lsp.enable({
  "gopls", "ruff-lsp", "rust_analyzer", "tsserver",
...
lspconfig.omnisharp.setup{
  ...
  on_attach = function(_, bufnr)
    ...
    buf_set_keymap('n', 'gi', "<cmd>lua require('omnisharp_extended').lsp_implementation()<CR>", "Go to Implementation")
    buf_set_keymap('n', '<leader>K', "<cmd>lua require('omnisharp_extended').lsp_type_definition()<CR>", "Type Definition")
    buf_set_keymap('n', 'gr', "<cmd>lua require('omnisharp_extended').telescope_lsp_references()<CR>", "Find References")
